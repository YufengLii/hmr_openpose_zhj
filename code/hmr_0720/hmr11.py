...
sys.path.append('/home/feng/human_zj/SMPL_python_v.1.0.0/smpl/')
...
smpl_model_used = load_model('/home/feng/human_zj/SMPL_python_v.1.0.0/smpl/models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl')
...
def set_params():
    ...
    params["model_folder"] = "/home/feng/human_zj/openpose/models/"
...
def write_obj(smpl_model_used, v, outmesh_path):
    ...
    # tmp_pose[0] = max(-0.2, v[0][3])
    # tmp_pose[0] = min(0.5, v[0][3])

    # tmp_pose[2] = max(-0.5, v[0][5])
    # tmp_pose[2] = min(0.5, v[0][5])
